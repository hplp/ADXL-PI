...
class ADXL362:
    ...
    def __init__(self, device=0, ce_pin=1):
        """
    ...
    def read_xyz(self):
        ...
        '''
        #self.spi.cshigh = False
        x = self.read_x() #* (2.048 * 2 / 2**20)
        y = self.read_y() #* (2.048 * 2 / 2**20)
        z = self.read_z() #* (2.048 * 2 / 2**20)
        temp = ((1852 - self.read_temp()) /9.05 +19.21)/10
